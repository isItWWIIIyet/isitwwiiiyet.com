...
(function ($) {
    $.fn.selectHierarchy = function (options) {
        ...
        obj.after('<select class="form-control drilldown drilldown-1"><option disabled selected value="">' + options.placeholder + '</option></select>');
        ...
        var change_handler = function () {
            ...
            if (node && node.children.length > 0) {
                this_select.after('<select class="form-control drilldown"><option selected disabled value="">' + options.placeholder + '</option></select>');
